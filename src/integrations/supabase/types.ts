...
export type Database = {
  ...
  public: {
      ...
      rides: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["child_id"];
            isOneToOne: false;
            referencedRelation: "passenger_children";
            referencedColumns: ["id"];
          },
        ];
      };
    ...
    Functions: {
      ...
      start_ride_with_pin: {
        Args: { _pin?: string | null; _ride_id: string };
        Returns: {
          accepted_at: string | null;
          cancellation_reason: string | null;
          cancelled_at: string | null;
      ...
      complete_ride_secure: {
        Args: {
          _distance: number;
          _dropoff_pin?: string | null;
          _duration: number;
          _fare: number;
          _lat?: number;
          _lng?: number;
    ...
    Enums: {
      ...
      driver_doc_kind: "identity" | "license" | "vehicle_registration" | "vehicle_documents";
      ...
      ride_offer_status: "pending" | "accepted" | "rejected" | "timeout" | "cancelled";
      ride_status:
        | "requested"
        | "searching"
        | "accepted"
